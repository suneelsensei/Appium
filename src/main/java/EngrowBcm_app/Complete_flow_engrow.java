...
public class Complete_flow_engrow {
	static WebDriver driver;
	static String url = "https://engrow-uat.senseitech.com/engrow-test-new";

//	static String application = "Ghhh Hhh";
	static String application = ApplicationCreation.name ;
	...
	public static void main(String[] args) throws Exception {
		...
		//RO app
		ApplicationCreation.main(args);
		
		BMReview();
		PrePdStage();
		
		//BCM app
		bcmsync_application.main(args);
	...
	public static void signout() throws Exception {
		driver.findElement(By.xpath(
				"/html/body/app-root/ig-layout/ig-layout-two-column/div/ig-header-component/mat-toolbar/div/div[3]/button"))
				.click();
		driver.findElement(By.xpath("/html/body/div[3]/div[2]/div/div/div/button[1]")).click();
	}
	...
	public static void Gotoapplication() throws Exception {
		...
		// Click on sign IN
		driver.findElement(By.xpath(
				"/html/body/app-root/ig-layout/ig-layout-two-column/div/mat-sidenav-container/mat-sidenav-content/app-login/div/div[2]/div/form/div[2]/button"))
				.click();

		// Click on Applications
		driver.findElement(By.xpath(
				"/html/body/app-root/ig-layout/ig-layout-two-column/div/mat-sidenav-container/mat-sidenav/div/ig-multi-level-menu/mat-nav-list/div[3]/ig-menu-item/a/div/mat-icon"))
				.click();
	...
	public static void BMReview() throws Exception {
		// Enter User name
		driver.findElement(By.xpath(
				"/html/body/app-root/ig-layout/ig-layout-two-column/div/mat-sidenav-container/mat-sidenav-content/app-login/div/div[2]/div/form/mat-form-field[1]/div/div[1]/div/input"))
				.sendKeys(bmuser);
		// Enter Password
		driver.findElement(By.xpath(
				"/html/body/app-root/ig-layout/ig-layout-two-column/div/mat-sidenav-container/mat-sidenav-content/app-login/div/div[2]/div/form/mat-form-field[2]/div/div[1]/div/input"))
				.sendKeys("Engrow@1");
...
//				.click();
		...
		driver.findElement(By.xpath("/html/body/app-root/ig-layout/ig-layout-two-column/div/mat-sidenav-container/mat-sidenav-content/eng-application-details/mat-sidenav-container/mat-sidenav-content/div/div/div[1]/mat-accordion/mat-expansion-panel[6]")).click();
		// Click on CFA
		driver.findElement(By.xpath(
